...
// Entity bis_city FormContext
export interface bis_cityFormContext extends Xrm.FormContext {
...
// Attribute constants
export const enum bis_cityAttributes {
  bis_cityId = "bis_cityid",
...
export interface bis_city extends IEntity {
  /*
  City UniqueidentifierType Unique identifier for entity instances
  */
  bis_cityid?: import("dataverse-ify").Guid | null;
  /*
  ...
  */
  ...
  /*
  City [Required] StringType The name of the custom entity.
  */
  bis_name?: string;
  /*
  State LookupType
  ...
  */
  ...
  /*
  Status bis_city_bis_city_statecode Status of the City
  */
  statecode?: import("../enums/bis_city_bis_city_statecode").bis_city_bis_city_statecode | null;
  /*
  Status Reason bis_city_bis_city_statuscode Reason for the status of the City
  */
  statuscode?: import("../enums/bis_city_bis_city_statuscode").bis_city_bis_city_statuscode | null;
  /*
