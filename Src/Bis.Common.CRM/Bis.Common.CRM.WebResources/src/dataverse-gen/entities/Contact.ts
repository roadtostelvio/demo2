...
export interface ContactFormContext extends Xrm.FormContext {
    ...
    */
    getAttribute(name: 'bis_asianname'): Xrm.Attributes.BooleanAttribute;
    /*
    
    */
    getControl(name: 'bis_asianname'): Xrm.Controls.OptionSetControl;
    /*
    
    */
    getAttribute(name: 'bis_ciamaccountid'): Xrm.Attributes.StringAttribute;
    /*
    
    */
    getControl(name: 'bis_ciamaccountid'): Xrm.Controls.StringControl;
    /*
    ...
    */
    getAttribute(name: 'bis_contacttype'): Xrm.Attributes.OptionSetAttribute;
    /*
    
    */
    getControl(name: 'bis_contacttype'): Xrm.Controls.OptionSetControl;
    /*
    
    */
    getAttribute(name: 'bis_cpmifieldofexpertise'): Xrm.Attributes.OptionSetAttribute;
    /*
    
    */
    getControl(name: 'bis_cpmifieldofexpertise'): Xrm.Controls.OptionSetControl;
    /*
    ...
    */
    getAttribute(name: 'bis_department'): Xrm.Attributes.StringAttribute;
    /*
    
    */
    getControl(name: 'bis_department'): Xrm.Controls.StringControl;
    /*
    
    */
    getAttribute(name: 'bis_embargorespect'): Xrm.Attributes.BooleanAttribute;
    /*
    
    */
    getControl(name: 'bis_embargorespect'): Xrm.Controls.OptionSetControl;
    /*
    
    */
    getAttribute(name: 'bis_embargorespecttrackdate'): Xrm.Attributes.DateAttribute;
    /*
    
    */
    getControl(name: 'bis_embargorespecttrackdate'): Xrm.Controls.DateControl;
    /*
    ...
    */
    getAttribute(name: 'bis_languagespoken'): Xrm.Attributes.OptionSetAttribute;
    /*
    
    */
    getControl(name: 'bis_languagespoken'): Xrm.Controls.OptionSetControl;
    /*
    
    */
    getAttribute(name: 'bis_prefix'): Xrm.Attributes.OptionSetAttribute;
    /*
    
    */
    getControl(name: 'bis_prefix'): Xrm.Controls.OptionSetControl;
    /*
    
    */
    getAttribute(name: 'bis_salutation'): Xrm.Attributes.OptionSetAttribute;
    /*
    
    */
    getControl(name: 'bis_salutation'): Xrm.Controls.OptionSetControl;
    /*
    ...
    */
    getAttribute(name: 'bis_sectionunit'): Xrm.Attributes.StringAttribute;
    /*
    
    */
    getControl(name: 'bis_sectionunit'): Xrm.Controls.StringControl;
    /*
    
    */
    getAttribute(name: 'bis_signedtcversion'): Xrm.Attributes.StringAttribute;
    /*
    
    */
    getControl(name: 'bis_signedtcversion'): Xrm.Controls.StringControl;
    /*
    
    */
    getAttribute(name: 'bis_tcsignaturedate'): Xrm.Attributes.DateAttribute;
    /*
    
    */
    getControl(name: 'bis_tcsignaturedate'): Xrm.Controls.DateControl;
    /*
    
    */
    getAttribute(name: 'bis_tcversionsigned'): Xrm.Attributes.StringAttribute;
    /*
    
    */
    getControl(name: 'bis_tcversionsigned'): Xrm.Controls.StringControl;
    /*
    ...
    */
    getAttribute(name: 'businesscardattributes'): Xrm.Attributes.StringAttribute;
    /*
    Stores Business Card Control Properties.
    */
    getControl(name: 'businesscardattributes'): Xrm.Controls.StringControl;
    /*
    ...
    */
    getAttribute(name: 'msdyn_orgchangestatus'): Xrm.Attributes.OptionSetAttribute;
    /*
    Whether or not the contact belongs to the associated account
    */
    getControl(name: 'msdyn_orgchangestatus'): Xrm.Controls.OptionSetControl;
    /*
    ...
    */
    getAttribute(name: 'msdyncrm_marketingformsubmissiondateprecise'): Xrm.Attributes.StringAttribute;
    /*
    
    */
    getControl(name: 'msdyncrm_marketingformsubmissiondateprecise'): Xrm.Controls.StringControl;
    /*
    
    */
    getAttribute(name: 'msdyncrm_rememberme'): Xrm.Attributes.BooleanAttribute;
    /*
    
    */
    getControl(name: 'msdyncrm_rememberme'): Xrm.Controls.OptionSetControl;
    /*
    
    */
    getAttribute(name: 'msevtmgt_aadobjectid'): Xrm.Attributes.StringAttribute;
    /*
    
    */
    getControl(name: 'msevtmgt_aadobjectid'): Xrm.Controls.StringControl;
    /*
    ...
    */
    getAttribute(name: 'msgdpr_donottrack'): Xrm.Attributes.BooleanAttribute;
    /*
    Select whether contact allows tracking interaction data. If Do Not Allow is selected, Microsoft Dynamics 365 will not save interaction data for the contact.
    */
    getControl(name: 'msgdpr_donottrack'): Xrm.Controls.OptionSetControl;
    /*
    
    */
    getAttribute(name: 'msgdpr_gdprconsent'): Xrm.Attributes.OptionSetAttribute;
    /*
    
    */
    getControl(name: 'msgdpr_gdprconsent'): Xrm.Controls.OptionSetControl;
    /*
    
    */
    getAttribute(name: 'msgdpr_gdprischild'): Xrm.Attributes.BooleanAttribute;
    /*
    
    */
    getControl(name: 'msgdpr_gdprischild'): Xrm.Controls.OptionSetControl;
    /*
...
export const enum ContactAttributes {
  ...
  BirthDate = "birthdate",
  bis_activity = "bis_activity",
  bis_activitycategory = "bis_activitycategory",
  bis_activitycategoryName = "bis_activitycategoryname",
  bis_activityName = "bis_activityname",
  bis_activitysubcategory = "bis_activitysubcategory",
  bis_activitysubcategoryName = "bis_activitysubcategoryname",
  bis_activitysubcategoryYomiName = "bis_activitysubcategoryyominame",
  bis_activityYomiName = "bis_activityyominame",
  bis_asianname = "bis_asianname",
  bis_bankingfunction = "bis_bankingfunction",
  bis_bankingfunctionName = "bis_bankingfunctionname",
  bis_ciamaccountid = "bis_ciamaccountid",
  bis_cisid = "bis_cisid",
  bis_contacttype = "bis_contacttype",
  bis_contingencyarrangements = "bis_contingencyarrangements",
  bis_contingencyarrangementsName = "bis_contingencyarrangementsname",
  bis_cpmifieldofexpertise = "bis_cpmifieldofexpertise",
  bis_cpmiinternalcontact = "bis_cpmiinternalcontact",
  bis_cpmiinternalcontactName = "bis_cpmiinternalcontactname",
  bis_cpmiinternalcontactYomiName = "bis_cpmiinternalcontactyominame",
  bis_creationsource = "bis_creationsource",
  bis_crmid = "bis_crmid",
  bis_department = "bis_department",
  bis_embargorespect = "bis_embargorespect",
  bis_embargorespecttrackdate = "bis_embargorespecttrackdate",
  bis_institutiongroup = "bis_institutiongroup",
  bis_institutiongroupName = "bis_institutiongroupname",
  bis_internationalprintaddress = "bis_internationalprintaddress",
  bis_languagespoken = "bis_languagespoken",
  bis_nationality = "bis_nationality",
  bis_nationalityName = "bis_nationalityname",
  bis_parentinstitution = "bis_parentinstitution",
  bis_parentinstitutionName = "bis_parentinstitutionname",
  bis_parentinstitutionYomiName = "bis_parentinstitutionyominame",
  bis_prefix = "bis_prefix",
  bis_ranking = "bis_ranking",
  bis_rankingName = "bis_rankingname",
  bis_reportsto = "bis_reportsto",
  bis_reportstoName = "bis_reportstoname",
  bis_reportstoYomiName = "bis_reportstoyominame",
  bis_salutation = "bis_salutation",
  bis_sanc = "bis_sanc",
  bis_sectionunit = "bis_sectionunit",
  bis_signedtcversion = "bis_signedtcversion",
  bis_stakeholderanalysis = "bis_stakeholderanalysis",
  bis_tcsignaturedate = "bis_tcsignaturedate",
  bis_tcversionsigned = "bis_tcversionsigned",
  Business2 = "business2",
...
export interface Contact extends IEntity {
  ...
  */
  ...
  Activity LookupType
  */
  bis_activity?: import("dataverse-ify").EntityReference | null;
  /*
  Activity Category LookupType
  */
  bis_activitycategory?: import("dataverse-ify").EntityReference | null;
  /*
   StringType
  */
  bis_activitycategoryname?: string | null;
  /*
   StringType
  */
  bis_activityname?: string | null;
  /*
  Activity Sub Category LookupType
  */
  bis_activitysubcategory?: import("dataverse-ify").EntityReference | null;
  /*
   StringType
  */
  bis_activitysubcategoryname?: string | null;
  /*
   StringType
  */
  bis_activitysubcategoryyominame?: string | null;
  /*
   StringType
  */
  bis_activityyominame?: string | null;
  /*
  Asian Name BooleanType
  */
  bis_asianname?: boolean | null;
  /*
  Banking Function LookupType
  */
  bis_bankingfunction?: import("dataverse-ify").EntityReference | null;
  /*
   StringType
  */
  bis_bankingfunctionname?: string | null;
  /*
  CIAM Account ID StringType
  */
  bis_ciamaccountid?: string | null;
  /*
  CIS ID IntegerType
  */
  bis_cisid?: number | null;
  /*
  Contact Type bis_contacttype
  */
  bis_contacttype?: import("../enums/bis_contacttype").bis_contacttype | null;
  /*
  Contingency Arrangements LookupType
  */
  bis_contingencyarrangements?: import("dataverse-ify").EntityReference | null;
  /*
   StringType
  */
  bis_contingencyarrangementsname?: string | null;
  /*
  CPMI Field of Expertise bis_contactcpmifieldofexpertise
  */
  bis_cpmifieldofexpertise?: import("../enums/bis_contactcpmifieldofexpertise").bis_contactcpmifieldofexpertise | null;
  /*
  CPMI Internal Contact LookupType
  */
  bis_cpmiinternalcontact?: import("dataverse-ify").EntityReference | null;
  /*
   StringType
  */
  bis_cpmiinternalcontactname?: string | null;
  /*
   StringType
  */
  bis_cpmiinternalcontactyominame?: string | null;
  /*
  ...
  */
  bis_department?: string | null;
  /*
  Embargo Respect BooleanType
  */
  bis_embargorespect?: boolean | null;
  /*
  Embargo Respect Track Date DateTimeType DateOnly:UserLocal
  */
  bis_embargorespecttrackdate?: Date | null;
  /*
  Institution Group LookupType
  */
  bis_institutiongroup?: import("dataverse-ify").EntityReference | null;
  /*
   StringType
  */
  bis_institutiongroupname?: string | null;
  /*
  International Print Address StringType
  */
  bis_internationalprintaddress?: string | null;
  /*
  Language Spoken bis_languagespoken
  */
  bis_languagespoken?: import("../enums/bis_languagespoken").bis_languagespoken[] | null;
  /*
  Nationality LookupType
  */
  bis_nationality?: import("dataverse-ify").EntityReference | null;
  /*
   StringType
  */
  bis_nationalityname?: string | null;
  /*
  Parent Institution LookupType
  */
  bis_parentinstitution?: import("dataverse-ify").EntityReference | null;
  /*
   StringType
  */
  bis_parentinstitutionname?: string | null;
  /*
   StringType
  */
  bis_parentinstitutionyominame?: string | null;
  /*
  Prefix bis_prefix
  */
  bis_prefix?: import("../enums/bis_prefix").bis_prefix | null;
  /*
  Ranking LookupType
  */
  bis_ranking?: import("dataverse-ify").EntityReference | null;
  /*
   StringType
  */
  bis_rankingname?: string | null;
  /*
  Reports To LookupType
  */
  bis_reportsto?: import("dataverse-ify").EntityReference | null;
  /*
   StringType
  */
  bis_reportstoname?: string | null;
  /*
   StringType
  */
  bis_reportstoyominame?: string | null;
  /*
  Salutation bis_salutation
  */
  bis_salutation?: import("../enums/bis_salutation").bis_salutation | null;
  /*
  SANC BooleanType
  */
  bis_sanc?: boolean | null;
  /*
  Section/Unit StringType
  */
  bis_sectionunit?: string | null;
  /*
  Signed T&C version StringType
  */
  bis_signedtcversion?: string | null;
  /*
  Stakeholder Analysis MemoType
  */
  bis_stakeholderanalysis?: string | null;
  /*
  T&C signature date DateTimeType DateOnly:UserLocal
  */
  bis_tcsignaturedate?: Date | null;
  /*
  T&C Version Signed StringType
  */
  bis_tcversionsigned?: string | null;
  /*
  ...
  */
  ...
  /*
  timestamp of form submission StringType
  */
  msdyncrm_marketingformsubmissiondateprecise?: string | null;
  /*
  Source landing page LookupType
  */
